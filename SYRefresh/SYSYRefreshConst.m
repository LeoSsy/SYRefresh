...
NSString *const SYRefreshViewFooterStateIdleTitle =  @"上拉加载更多数据";
NSString *const SYRefreshViewFooterPullingTitle =    @"释放即可加载数据";
NSString *const SYRefreshViewFooterRefreshingTitle = @"正在加载中...";
NSString *const SYRefreshViewNoMoreDataTitle = @"—————— 别再上拉了，再拉我也长不高 ——————";
